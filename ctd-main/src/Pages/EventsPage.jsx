...
const EventsPage = () => {
  const eventsData = [
    ...
    },
    {
      ...
      name: "DECODE RUSH",
      description:
        "Decode Rush is a unique and immersive outdoor quest designed to ignite your sense of adventure. Participants embark on a thrilling scavenger hunt, armed with just two crucial elements: a clue that leads to the next location and a riddle that holds the answer.",
      rules: [],
      height: "35vh",
      width: "43vw",
      color: "#529DA0",
  ...
  return (
    <>
      <div>
        <div className="Container bg--500 h-[100vh] flex flex-col justify-center items-center w-[100vw]">
          <div className="head w-full h-[30%] bg--400 flex flex-col justify-end items-start px-[4vw] text-white">
            <h1 className="text-[6vw] bg--500 h-[16vh] flex justify-center items-center">EVENTS</h1>
          </div>
          <div className="maincontent w-[100%] h-[70%] bg--500 flex flex-col justify-start items-center  gap-[2vw] px-[4vw]">
            <div className="flex flex-row gap-8  max-md:gap-4 max-md:flex-col">
